                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  child: DropdownButton<City>(
                                    ...
                                    onChanged: (City? newValue) {
                                      setState(() {
                                        ...
                                        context.read<WeatherProvider>().updateLocation(selectedCity!.city);
                        ...
                        SizedBox(
                          height: 160,
                          child: Image.asset(
                            "assets/" + data.currentWeather.condition.toLowerCase().replaceAll(' ', '') + ".png",
                          ),
                        ),
                        Row(
                        ...
                        Text(
                          DateFormat("MMMMEEEEd").format(DateTime.parse(data.forecastDay[0].date)),
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 16.0,
                            fontWeight: FontWeight.bold,
                              ...
                              onTap: () => Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => DetailPage(
                                    dailyForecastWeather: data.forecastDay,
                                  ),
                                ),
                              ),
                              child: Text(
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Image.asset(
                                        "assets/" + data.forecastDay[0].hour[index].condition.replaceAll(' ', '').toLowerCase() + ".png",
                                        width: 40,
                                        height: 40,
                                      ),
                                      Text(
                                        data.forecastDay[0].hour[index].time.substring(11, 16),
                                        style: const TextStyle(fontWeight: FontWeight.bold),
                                      ),
                                      Text(
                                        data.forecastDay[0].hour[index].tempC.toString() + '°',
